...
class Agglomerative:
    ...
    """
    Method to initialize the agglomertaives class, it need the dataframe as parameter
    """
    def __init__(self, X):
        self.X = X.to_numpy()
        self.K = 2
    ...
    """
    Method that allows us to define the name of the dataframe, the name is important while plotting the dendrogram
    """
    def setDatasetName(self, name):
        self.dataset_name = name

    """
    Functions that allows us to apply the agglomerative clustering on the dataframe
    """
    ...
    """
    Method that allows us to plot the dendrogram of the clustering
    """
