...
class KMeans:
    """
    Method to initialize the KMeans class, it needs the dataframe as parameter
    """
    def __init__(self, X):
        self.X = X.to_numpy()
        self.K = 0
    ...
    """
    Method that returns the centroids of the clusters obtained after applying KMeans
    """
    def getCenters(self):
        return self.centers

    """
    Method that returns the list of labels of each point in the dataset
    """
    def getClusters(self):
        return self.clusters

    """
    Method that allow us define the distance method while doing the clustering
    """
    ...
    """
    Method that allow us define the initialization method for the initial clusters
    """
    ...
    """
    Method that allows us to define the seed for obtaining random numbers
    """
    ...
    """
    Function that initializes the initial clusters using the forgy technique
    """
    ...
    """
    Function that initializes the initial clusters using the Kmeans++ technique
    """
    ...
    """
    Method that recomputes the cluster centroids basing on the current information of the points
    """
    ...
    """
    Method that computes the membership of each function basing on distance from the nearest centroid
    """
